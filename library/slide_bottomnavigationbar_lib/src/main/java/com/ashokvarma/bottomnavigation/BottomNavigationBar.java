...
public class BottomNavigationBar extends FrameLayout {
    ...
    private int bgColorForce;
    public void setBgColorForce(int bgColorForce) {
        this.bgColorForce = bgColorForce;
    }
    ...
    private String colorTab = "#e91e63";

    public String getColorTab() {
        return colorTab;
    }

    public void setColorTab(String colorTab) {
...
//            mActiveColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbActiveColor, Color.parseColor("#e91e63"));
...
//            mBackgroundColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbBackgroundColor, Color.WHITE);
            mBackgroundColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbBackgroundColor, Color.parseColor(colorTab));
...
//            mBackgroundColor = Color.WHITE;
            mBackgroundColor = Color.parseColor(colorTab);
...
//                    mContainer.setBackgroundColor(clickedView.getActiveColor());
                    mContainer.setBackgroundColor(bgColorForce);
...
//                            BottomNavigationHelper.setBackgroundWithRipple(clickedView, mContainer, mBackgroundOverlay, clickedView.getActiveColor(), mRippleAnimationDuration);
                            BottomNavigationHelper.setBackgroundWithRipple(clickedView, mContainer, mBackgroundOverlay, bgColorForce, mRippleAnimationDuration);
//                            } catch (Exception e) {
//                                mContainer.setBackgroundColor(clickedView.getActiveColor());
//                                mBackgroundOverlay.setVisibility(View.GONE);
//                            }
